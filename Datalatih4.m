...
Mdl1 = fitcecoc(data_latih, target_latih);

% Melakukan pelatihan menggunakan algoritma MSVM dengan kernel linear
Mdl_linear1 = fitcecoc(data_latih, target_latih, 'Learners', templateSVM('KernelFunction', 'linear'));

% Melakukan pelatihan menggunakan algoritma MSVM dengan kernel polynomial
Mdl_poly1 = fitcecoc(data_latih, target_latih, 'Learners', templateSVM('KernelFunction', 'polynomial'));

% Melakukan pelatihan menggunakan algoritma MSVM dengan kernel RBF (Gaussian)
Mdl_rbf1 = fitcecoc(data_latih, target_latih, 'Learners', templateSVM('KernelFunction', 'rbf'));


% membaca kelas keluaran hasil pelatihan
kelas_keluaran = predict (Mdl1,data_latih);

kelas_keluaranlinear = predict (Mdl_linear1, data_latih);

kelas_keluaranpoly = predict (Mdl_poly1, data_latih);

kelas_keluaranrbf = predict (Mdl_rbf1, data_latih);
...
%menyimpan model support vector machine hasil pelatihan
save Mdl1 Mdl1
