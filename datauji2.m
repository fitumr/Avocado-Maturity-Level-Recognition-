...
kelas_prediksi = predict(Mdl2, data_uji);

kelas_prediksilinear = predict (Mdl_linear2, data_uji);

kelas_prediksipoly = predict (Mdl_poly2, data_uji);

kelas_prediksirbf = predict (Mdl_rbf2, data_uji);
